...
const brighteningSteps = [
  {
    label: "01 — Cleanse · Velvet Touch Face Wash",
    detail: "Gently cleanse your face and prepare the skin for your treatment step.",
  },
  {
    label: "02 — Treat · Velvet Touch Face Serum",
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-8 pt-14 pb-20 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h1 className="font-display text-4xl md:text-6xl leading-[1.05] text-[var(--deep-wine)]">
            ...
            <em className="italic text-[var(--dusty-rose)]">you.</em>
          </h1>
      ...
      <section className="border-y border-[var(--line)] bg-[var(--milk-sage)]">
        <div className="max-w-7xl mx-auto px-5 md:px-8 py-6 flex flex-wrap justify-center gap-x-10 gap-y-3">
          {usps.map((u) => (
            <span
              key={u}
              className="text-xs md:text-sm uppercase tracking-wider text-[var(--deep-wine)] font-medium"
            >
              {u}
            </span>
          ))}
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-8 py-20">
        <h2 className="font-display text-3xl md:text-4xl text-[var(--deep-wine)] mb-10">
          Shop by Concern
        </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          {concerns.map((c) => (
            ...
            >
              <div
                className={`absolute inset-0 ${c.color} opacity-80 group-hover:opacity-100 transition-opacity`}
              />
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-8 py-20">
        <div className="flex items-baseline justify-between mb-10">
          <h2 className="font-display text-3xl md:text-4xl text-[var(--deep-wine)]">
            Best Sellers
          </h2>

          <Link
            href="/shop?sort=bestselling"
            className="text-sm text-[var(--warm-gold)] font-medium"
          >
            View All &rarr;
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-8 py-20">
        <div className="max-w-2xl mb-12">
          <p className="text-xs uppercase tracking-[0.18em] text-[var(--warm-gold)] mb-3">
          ...
          <p className="text-[var(--muted)] max-w-xl">
            The right products in the right order can turn your daily skincare
            into a simple, consistent ritual.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <RoutineThread
            ...
            steps={brighteningSteps}
          />

          {/* Acne & Blemish Routine */}
          <RoutineThread
            title="Acne & Blemish Routine"
            steps={blemishSteps}
          />
        ...
        <div className="mt-10">
          <Link
            ...
            className="inline-block border border-[var(--deep-wine)] text-[var(--deep-wine)] px-7 py-3.5 rounded-full text-sm font-medium hover:bg-[var(--milk-sage)] transition-colors"
          >
      ...
      <section className="bg-[var(--milk-sage)] border-y border-[var(--line)] py-16">
        <div className="max-w-7xl mx-auto px-5 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <div className="font-display text-2xl text-[var(--deep-wine)] mb-1">
              11
            </div>
