...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-[60] flex items-center gap-3 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-lg shadow-black/15 transition-all hover:scale-105 hover:shadow-xl md:bottom-6 md:right-6"
    >
